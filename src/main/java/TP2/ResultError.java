 ...
 * errores. En este caso es con errores y lo que hace es heredar de Result y cuando se crea le
 * dice que es un resultado con errores y a la descripcion se le agrega el texto para que cuando
