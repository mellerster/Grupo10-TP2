 ...
 * en este caso es el fallido y lo que hace es heredar de Result y cuando se crea le dice 
 * que es un resultado fallido y a la descripcion se le agrega el texto para que cuando 
