...
public class TestAnalyzer {
     ...
     * crashed without executing fully.  It's never null, but can be empty.
     * Key: Test or TestContainer name
     * Value: All the tests that failed in the Test or TestContainer
     */
    protected Map<String, List<TestResult>> failures =
     ...
     * Key: Test or TestContainer name
     * Value: All the tests that have an error in the Test or TestContainer
     */
    protected Map<String, List<TestResult>> errors =
            new HashMap<String, List<TestResult>>();
     ...
     * Key: Test or TestContainer name
     * Value: All the tests that have passed in the Test or TestContainer
     */
    protected Map<String, List<TestResult>> passed =
            new HashMap<String, List<TestResult>>();
     ...
     * Adds a failure test.
     *
     * @param test    The test that has failed. It cannot be null.
     * @param message A {@link message} about the error. It cannot be null.
     */
     ...
     * Adds an error test.
     *
     * @param test    The error test. It cannot be null
     * @param message A {@link message} about the error. It cannot be null.
     */
     ...
     * Adds a passed test.
     *
     * @param test The test that has passed. It cannot be null
     */
     ...
     *
     * @param test The test to be added. It cannot be null.
     */
     ...
     *
     * @param test The test to be analyzed. It cannot be null.
     */
     ...
     *
     * @param theCurrentTestName The name of the Current Test. It cannot be empty
     *                           nor null.
     */
