...
public class TestRunner {
    ...
    public void execute(final String... tags) {
        ...
        //By default we generate a console report but we can change format using setFormat method.
     ...
     *
     * @param test The Test to be run and analyzed. It cannot be null.
     ...
     *
     * @param validTestRegex The regex expression to be used for matching.
     */
